...
function updateFile(file) {
  ...
  const search = `          $SDL_URL = "https://github.com/libsdl-org/SDL/releases/download/preview-3.1.3/SDL3-devel-3.1.3-mingw.zip"
  ...
  const replace = `          $SDL_URL = "https://github.com/libsdl-org/SDL/releases/download/preview-3.1.3/SDL3-devel-3.1.3-VC.zip"
          Invoke-WebRequest -Uri $SDL_URL -OutFile SDL3.zip
          Expand-Archive SDL3.zip -DestinationPath C:\\SDL3
