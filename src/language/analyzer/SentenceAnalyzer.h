...
namespace Image2Card::Language::Morphology
{
...
namespace Image2Card::Language::PitchAccent
{
...
public:
   ...
   */
    ...
    AnalyzeSentence(const std::string& sentence, const std::string& targetWord, const ILanguage* language = nullptr);
