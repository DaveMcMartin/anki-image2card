...
public:
   ...
   */
    ...
    /**
   * Get the translator instance if this service provides translation.
   * @return Shared pointer to translator, or nullptr if not a translator service
   */
    [[nodiscard]] virtual std::shared_ptr<Translation::ITranslator> GetTranslator() const { return nullptr; }
  };
