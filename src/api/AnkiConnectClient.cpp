...
int64_t AnkiConnectClient::AddNote(const std::string& deckName, const std::string& modelName, const std::map<std::string, std::string>& fields, const std::vector<std::string>& tags)
{
    nlohmann::json note;
